    ...
    return(
        <div className="flex flex-wrap w-[240px] h-[400px] m-2 rounded-2xl bg-gray-100 hover:bg-gray-200" >
            ...
            <span className="px-2 w-[220px] font-mono flex">
                ...
                <span className="ml-2">({restData.info.totalRatingsString})</span>
                <span className="ml-4">{restData.info.sla['slaString']}</span>
            </span>
            <span className="px-2 w-[220px] font-thin font-sans">{restData.info.isOpen ? "Open," +" Closes At "+ restData.info.availability['nextCloseTime'] : "Closed"}</span>
